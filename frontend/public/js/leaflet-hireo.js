...
$(document).ready(function () {
  ...
  function singleListingMap () {
    const lng = parseFloat($('#singleListingMap').data('longitude'))
    const lat = parseFloat($('#singleListingMap').data('latitude'))
    ...
    const map_single = L.map('singleListingMap', mapOptions)
    const zoomOptions = {
