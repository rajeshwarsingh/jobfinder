          ...
          <div className='freelancer-overview manage-candidates'>
            <div className='freelancer-overview-inner'>
              ...
              <div className='freelancer-name'>
                <h4><a href='#'>{title} <img className='flag' src={require('../../../assets/images/flags/de.svg')} alt='' title='Germany' data-tippy-placement='top' /></a></h4>
                ...
                <div className='buttons-to-right always-visible margin-top-25 margin-bottom-0'>
                  <button disabled={(currentProposalStatus === 'accepted')} onClick={this.handleOfferAccept} className='popup-with-zoom-anim button ripple-effect'> {currentProposalStatus === 'accepted' && <i className='icon-material-outline-check' />} {currentProposalStatus === 'accepted' ? 'Accepted' : ('Accept Offer')}</button>
