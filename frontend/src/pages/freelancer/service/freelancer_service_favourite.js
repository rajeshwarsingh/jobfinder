...
import { getFavouriteService } from '../../../Actions'
// import { Wishlist } from '../../../Components/favourite/wishlist'
import { FavouriteItem } from '../../../Components/favourite/fav_service_item'

export class FreelancerServiceFavourite extends React.Component {
  constructor () {
    super()
    this.state = {
      favourite: []
