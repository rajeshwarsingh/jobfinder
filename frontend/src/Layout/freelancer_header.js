...
export class HeaderFreelancer extends Component {
  constructor() {
    super()
    this.state = {
      userProfile: {},
      ...
      headerNotiCss : 'header-notifications'
    }
  ...
  markNotificationRead(item) {
    // alert(1)
    this.setState({headerNotiCss:'header-notifications'}) 
          ...
          <div className='container'>
              ...
              <nav id='navigation'>
                <ul id='responsive'>
                  <li><a href="#">Search</a>
                    ...
                    <li><Link className={(activeObj.activeFindJobber ? 'current' : '')} to='/freelancer/search'>Search {displayNameSettings.freelancer}</Link></li>
                    <li><Link className={(activeObj.activeFindJoblot ? 'current' : '')} to='/freelancer/service_search'>Search {displayNameSettings.service}</Link></li>
                    <li><Link className={(activeObj.activeFindJoblem ? 'current' : '')} to='/freelancer/posts'>Search {displayNameSettings.post}</Link></li>
                    </ul>
                  </li>
                  <li><a href="#">Create</a>
                    <ul class="dropdown-nav">
                    <li><Link className={(activeObj.activeCreatejoblot ? 'current' : '')} to='/freelancer/service/create'>Create {displayNameSettings.service}</Link></li>
                    <li><Link to='/hiremngr/post/create'>Create {displayNameSettings.post}</Link></li>
                    </ul>
                  </li>
                  {/* <li><Link className={(activeObj.activeFindJobber ? 'current' : '')} to='/freelancer/search'>Find {displayNameSettings.freelancer}</Link></li>
                  <li><Link className={(activeObj.activeFindJoblot ? 'current' : '')} to='/freelancer/service_search'>Find {displayNameSettings.service}</Link></li>
                  <li><Link className={(activeObj.activeFindJoblem ? 'current' : '')} to='/freelancer/posts'>Find {displayNameSettings.post}</Link></li> */}
                  <li><Link className={(activeObj.activeJobspace ? 'current' : '')} to='/freelancer/dashboard'>{displayNameSettings.freelancerDashboard}</Link></li>
                  {/* <li><Link className={(activeObj.activeCreatejoblot ? 'current' : '')} to='/freelancer/service/create'>Create {displayNameSettings.service}</Link></li> */}
                  {/* <li><Link className={(activeObj.activeHirejobster ? 'current' : '')} to='/hiremngr/dashboard'><span style={{ color: 'red' }}>Switch to {displayNameSettings.hiremanager}</span></Link></li> */}
            ...
            <div className='right-side'>
              ...
              <div className='header-widget hide-on-mobile'>
                ...
                {/* <!-- Notifications --> */}
                <div className={this.state.headerNotiCss}>
